...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2022 at 05:01 PM
...
INSERT INTO `user` (`user_id`, `username`, `password`, `roleID`) VALUES
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `user` (`user_id`);
...
--
ALTER TABLE `user_info`
  ADD CONSTRAINT `user_info_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user` (`user_id`);
COMMIT;
